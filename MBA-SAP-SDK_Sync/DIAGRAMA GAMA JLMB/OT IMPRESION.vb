Public Class OT_IMPRESION
    ...
    Private Sub Label4_Click(sender As Object, e As EventArgs) Handles Label14.Click
    ...
    Private Sub Button14_Click(sender As Object, e As EventArgs) Handles Button14.Click, Button21.Click, Button49.Click
    ...
    Private Sub Panel39_Paint(sender As Object, e As PaintEventArgs) Handles Panel41.Paint, Panel47.Paint, Panel63.Paint, Panel65.Paint, Panel67.Paint, Panel71.Paint

    End Sub

    Private Sub Panel40_Paint(sender As Object, e As PaintEventArgs) Handles Panel42.Paint, Panel48.Paint, Panel64.Paint, Panel66.Paint, Panel68.Paint, Panel74.Paint

    End Sub

    Private Sub Label74_Click(sender As Object, e As EventArgs) Handles Label72.Click, Label99.Click, Label120.Click, Label160.Click, Label174.Click, Label222.Click
    ...
    Private Sub ComboBox44_SelectedIndexChanged(sender As Object, e As EventArgs)
    ...
    Private Sub Panel41_Paint(sender As Object, e As PaintEventArgs)

    End Sub

    Private Sub Panel42_Paint(sender As Object, e As PaintEventArgs)
    ...
    Private Sub ComboBox31_SelectedIndexChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub ComboBox32_SelectedIndexChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub ComboBox33_SelectedIndexChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub DateTimePicker17_ValueChanged(sender As Object, e As EventArgs)
    ...
    Private Sub Panel37_Paint(sender As Object, e As PaintEventArgs)
    ...
    Private Sub TextBox16_TextChanged(sender As Object, e As EventArgs) Handles TextBox5.TextChanged, TextBox133.TextChanged, TextBox131.TextChanged, TextBox129.TextChanged, TextBox125.TextChanged, TextBox121.TextChanged, TextBox118.TextChanged, TextBox115.TextChanged
    ...
    Private Sub ComboBox19_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox19.SelectedIndexChanged, ComboBox143.SelectedIndexChanged, ComboBox142.SelectedIndexChanged, ComboBox144.SelectedIndexChanged, ComboBox145.SelectedIndexChanged
    ...
    Private Sub Button11_Click(sender As Object, e As EventArgs) Handles Button11.Click, Button43.Click
    ...
    Private Sub DateTimePicker11_ValueChanged(sender As Object, e As EventArgs)
    ...
    Private Sub TextBox25_TextChanged(sender As Object, e As EventArgs) Handles TextBox25.TextChanged, TextBox201.TextChanged
    ...
    Private Sub ComboBox25_SelectedIndexChanged(sender As Object, e As EventArgs)
    ...
    Private Sub TextBox10_TextChanged(sender As Object, e As EventArgs) Handles TextBox10.TextChanged, TextBox209.TextChanged, TextBox208.TextChanged, TextBox206.TextChanged, TextBox205.TextChanged, TextBox58.TextChanged

    End Sub

    Private Sub TextBox9_TextChanged(sender As Object, e As EventArgs) Handles TextBox263.TextChanged, TextBox262.TextChanged, TextBox261.TextChanged, TextBox491.TextChanged, TextBox490.TextChanged, TextBox489.TextChanged, TextBox494.TextChanged, TextBox493.TextChanged, TextBox492.TextChanged, TextBox13.TextChanged, TextBox12.TextChanged, TextBox11.TextChanged
    ...
    Private Sub TextBox7_TextChanged(sender As Object, e As EventArgs) Handles TextBox7.TextChanged, TextBox202.TextChanged
    ...
    Private Sub Label117_Click(sender As Object, e As EventArgs) Handles Label117.Click, Label129.Click, Label128.Click, Label127.Click, Label126.Click, Label125.Click, Label124.Click, Label123.Click, Label130.Click, Label131.Click, Label162.Click, Label163.Click, Label165.Click, Label167.Click, Label169.Click, Label234.Click, Label75.Click, Label703.Click, Label702.Click

    End Sub

    Private Sub TextBox149_TextChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub Label197_Click(sender As Object, e As EventArgs) Handles Label203.Click

    End Sub

    Private Sub TextBox156_TextChanged(sender As Object, e As EventArgs)
    ...
    Private Sub Label235_Click(sender As Object, e As EventArgs) Handles Label235.Click, Label238.Click, Label237.Click, Label236.Click, Label548.Click, Label677.Click, Label676.Click
    ...
    Private Sub Label176_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub Label290_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub Label345_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub Label335_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub ComboBox183_SelectedIndexChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub Label338_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub Label351_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub ComboBox182_SelectedIndexChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub Label352_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub ComboBox184_SelectedIndexChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub Label353_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub ComboBox185_SelectedIndexChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub ComboBox186_SelectedIndexChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub Label355_Click(sender As Object, e As EventArgs)
    ...
    Private Sub Label356_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub ComboBox188_SelectedIndexChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub Label357_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub ComboBox189_SelectedIndexChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub Label358_Click(sender As Object, e As EventArgs)
    ...
    Private Sub ComboBox190_SelectedIndexChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub ComboBox191_SelectedIndexChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub ComboBox192_SelectedIndexChanged(sender As Object, e As EventArgs)
    ...
    Private Sub TextBox399_TextChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub TextBox390_TextChanged(sender As Object, e As EventArgs)
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs) Handles Label535.Click, Label549.Click

    End Sub

    Private Sub Label566_Click(sender As Object, e As EventArgs) Handles Label566.Click, Label601.Click, Label685.Click

    End Sub

    Private Sub TextBox266_TextChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub Label584_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub Label585_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub ComboBox53_SelectedIndexChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub Label587_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub ComboBox286_SelectedIndexChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub Panel129_Paint(sender As Object, e As PaintEventArgs)

    End Sub

    Private Sub ComboBox245_SelectedIndexChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub Label650_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub TextBox178_TextChanged(sender As Object, e As EventArgs) Handles TextBox178.TextChanged, TextBox177.TextChanged

    End Sub

    Private Sub TextBox190_TextChanged(sender As Object, e As EventArgs) Handles TextBox190.TextChanged, TextBox189.TextChanged

    End Sub

    Private Sub TextBox535_TextChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub TextBox533_TextChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub TextBox534_TextChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub Label678_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub Label680_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub Panel266_Paint(sender As Object, e As PaintEventArgs)
