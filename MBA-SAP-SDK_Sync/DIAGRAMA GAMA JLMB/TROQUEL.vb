...
﻿Public Class OT6
    ...
    Private Sub Label150_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub Panel119_Paint(sender As Object, e As PaintEventArgs) Handles Panel119.Paint
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click, Button13.Click
